...
class ZRect:
    ...
    def contains(self, *other):
        rect = self.__class__(*other)
        return self.x <= rect.x and self.y <= rect.y and self.x + self.w >= rect.x + rect.w and self.y + self.h >= rect.y + rect.h and self.x + self.w > rect.x and self.y + self.h > rect.y
    ...
    def colliderect(self, *other):
        rect = self.__class__(*other)
        return self.x < rect.x + rect.w and self.y < rect.y + rect.h and self.x + self.w > rect.x and self.y + self.h > rect.y
